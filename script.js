  ...
  if (contactForm) {
    contactForm.addEventListener('submit', function(e) {
      ...
      if (!name || !email || !phone || !terms) {
        alert('נא למלא את כל השדות החובה ולאשר את תנאי השימוש');
        return;
      }
        ...
        (async function() {
          try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
              ...
              body: JSON.stringify({
                websiteId: 'a8ef2c11-3905-45e2-991f-3b6033826b9a',
                name: name,
                email: email,
      ...
      alert('תודה על פנייתך! ניצור איתך קשר בהקדם האפשרי.');
      contactForm.reset();
    });
  }
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "eitan משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
